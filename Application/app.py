...
def getMysqlConnection():
    return mysql.connector.connect(user=f'{os.getenv("DB_USER")}', host=f'{os.getenv("DB_HOST")}', port=f'{int(os.getenv("DB_PORT"))}', password=f'{os.getenv("DB_PASSWORD")}', database=f'{os.getenv("DB_DATABASE")}',auth_plugin='mysql_native_password')
